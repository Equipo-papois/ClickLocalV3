...
export function Login() {
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <Link 
        to="/" 
        className="fixed top-6 left-6 flex items-center gap-2 text-gray-500 hover:text-[#ff7b9d] transition-colors font-medium"
      >
      ...
      <div className="bg-white p-8 rounded-3xl shadow-xl w-full max-w-md border border-gray-100">
        <div className="text-center mb-8">
          <div className="bg-pink-50 w-16 h-16 rounded-2xl flex items-center justify-center mx-auto mb-4 rotate-3">
            <LogIn className="w-8 h-8 text-[#ff7b9d] -rotate-3" />
          </div>
          <h2 className="text-2xl font-bold text-gray-800" style={{ fontFamily: 'Montserrat, sans-serif' }}>
            ¡Hola de nuevo!
          </h2>
          <p className="text-gray-500 mt-2">Ingresa a tu cuenta de Click Local</p>
        </div>
        ...
        <form className="space-y-4">
          ...
          <button 
            type="submit"
            className="w-full bg-[#ff7b9d] text-white py-3 rounded-xl font-bold hover:bg-[#ff648a] transition-all shadow-lg shadow-pink-200 mt-4"
          >
            Iniciar Sesión
          </button>
        </form>
